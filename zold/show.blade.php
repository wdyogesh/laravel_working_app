				...
				<div class="col-sm-8">
					<form class="form-group">
				        ...
				        <div class="form-group">
				        	<a href="{{ route('partner.bookings') }}" class="btn btn-danger" role="button" aria-pressed="true">Cancel</a>
				        	<a href="{{ route('partner.booking.edit', $booking->id) }}" class="btn btn-primary" role="button" aria-pressed="true">Edit Booking Information</a>
				        </div>

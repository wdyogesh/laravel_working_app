...
@section('content')
    ...
    <div class="starter-template">
        ...
        <nav class="breadcrumb">
			<a class="breadcrumb-item" href=" {{ route('chat', ['student_id' => $booking->student_id , 'host_id' => $booking->vacancy->house->user_id]) }} ">Chat</a>
		</nav>
				...
				<div class="col-sm-8">
					<form class="form-group">
				        ...
				        <div class='form-group row'>
				        	...
				        	<div class="col-md-8">
								<input id="length_stay" type="text" class="form-control" name="length_stay" value="{{ $booking->length_stay }}" disabled>
							</div>
						</div>
						...
						<div class='form-group row'>
				        	...
				        	<div class="col-md-8">
								<input id="checkout" type="text" class="form-control" name="checkout" value="{{ $booking->checkout }}" disabled>
							</div>
						</div>
				        ...
				        <div class="form-group row" id="return_trip" @if(!$booking->pickup) style="display:none" @endif>
						...
						<div class="form-group">
							<a href="{{ route('student.index') }}" class="btn btn-primary" role="button" aria-pressed="true">Back to Dashboard</a>
				        </div>

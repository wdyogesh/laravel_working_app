					...
					<form class="form-group">
				        ...
				        <div class="form-group">
					        ...
					        @elseif(Auth::user()->isAdmin())
					        	<a href="{{ route('admin.booking.edit', $booking->id) }}" class="btn btn-primary" role="button" aria-pressed="true">Edit Information</a>
					        @elseif(Auth::user()->isStudent())
					        @elseif(Auth::user()->isPartner())
					        <!--
					        	<a href="{{ route('partner.booking.edit', $booking->id) }}" class="btn btn-primary" role="button" aria-pressed="true">Edit Information</a>
					        -->
					        @endif
				        </div>
